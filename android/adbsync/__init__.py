...
"""git@github.com:SelfAdjointOperator/better-adb-sync.git"""
...
from .SAOLogging import FATAL, logging_fatal, perror, setup_root_logger
__version__ = "1.2.0"
    ...
    if args.delete_excluded and args.delete:
        ...
        if tree_unaccounted_destination_non_excluded is not None:
            ...
            fs_destination.remove_tree(
                path_destination, tree_unaccounted_destination_non_excluded, dry_run=args.dry_run)
        else:
